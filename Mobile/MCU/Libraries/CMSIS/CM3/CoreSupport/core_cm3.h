 ...
 */
extern uint32_t __REV16(unsigned short value);
 ...
 */
extern uint8_t __LDREXB(unsigned char const volatile *addr);
 ...
 */
extern uint16_t __LDREXH(unsigned short const volatile *addr);
 ...
 */
extern unsigned long __STREXB(unsigned char value, unsigned char volatile *addr);
 ...
 */
extern unsigned long __STREXH(unsigned short value, unsigned short volatile *addr);
 ...
 * Exclusive STR command for 8 bit values
 */
extern uint32_t __STREXB(unsigned char value, unsigned char const volatile *addr);
 ...
 * Exclusive STR command for 16 bit values
 */
extern uint32_t __STREXH(unsigned short value, unsigned short const volatile *addr);
